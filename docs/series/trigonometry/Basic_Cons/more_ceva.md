...
<figure style="text-align: center; margin: 1em 0;">
  <img 
    src="../../../assets/images/塞瓦型_default.png" 
    class="only-light" 
    alt="塞瓦型" 
    style="height: 250px; display: inline-block; vertical-align: middle;"
  >
  <img 
    src="../../../assets/images/塞瓦型_slate.png" 
    class="only-dark" 
    alt="塞瓦型" 
    style="height: 250px; display: inline-block; vertical-align: middle;"
  >
...
<Admonition type="example" title="例题" :collapsible="false">
...
$$ \angle I_1 A P=\alpha \implies\angle A P I_1=\dfrac{\pi+C}{2} $$
    
同理：
$$ \angle A P I_2=\dfrac{\pi+B}{2} , \angle I_1 P I_2=\dfrac{\pi+A}{2} $$
...
$$ \dfrac{I_1 F \cdot A I_2}{\sin(\dfrac{\pi-C}{2}-\alpha)}=\dfrac{I_2 F \cdot A I_1}{\sin(\dfrac{C}{2}+\alpha)} \implies \dfrac{I_1 F}{I_2 F}=\dfrac{A I_1}{A I_2} \cdot \dfrac{\cos(\dfrac{C}{2}+\alpha)}{\sin(\dfrac{C}{2}+\alpha)}. $$
...
$$ \implies \dfrac{I_1 F}{I_2 F}=\dfrac{\sin \angle I_1 I_2 F}{\sin \angle I_2 I_1 F}=\dfrac{\cos(\dfrac{C}{2}+\alpha+\beta)}{\sin(\dfrac{C-A}{2}+\alpha+\beta)}=\dfrac{\cos(\dfrac{C}{2}+\angle B A F)}{\sin(\dfrac{C-A}{2}+\angle B A F)}=\dfrac{\cos \dfrac{C}{2}}{\cos \dfrac{B}{2}} $$
