...
$$ \begin{aligned} O_i O_j^2 &=O O_i^2 +O O_j^2 - 2O O_i \cdot O O_j \cos \angle O_i O O_j \\
&=(R-R_i)^2+(R-R_j)^2-2(R-R_i)(R-R_j)\cos \angle K_i O K_j, \\
\cos \angle K_i O K_j &= 1 - 2 \sin^2 \dfrac{\angle K_i O K_j}{2} = 1-2(\dfrac{K_i K_j}{2R})^2. \end{aligned} $$

代入 $(\star)$ 式有：

$$ \begin{aligned} t_{ij}^2&=2R^2-2R(R_i+R_j)+R_i^2+R_j^2-(R^2-R(R_i+R_j)+R_i R_j)(2-\dfrac{K_i K_j^2}{R^2})-(R_i-R_j)^2 \\
&=(R_i-R_j)^2+\dfrac{(R-R_i)(R-R_j)(K_i K_j^2)}{R^2-(R_i-R_j)^2}=\dfrac{(R-R_i)(R-R_j)(K_i K_j^2)}{R^2} \end{aligned} $$
    
即
$$ t_{ij}=K_i K_j \sqrt{\dfrac{(R-R_i)(R-R_j)}{R}}. $$
    
故由托勒密定理，
$$ \begin{aligned} t_{12}t_{34}+t_{1 4}t_{2 3}&=\sqrt{\dfrac{(R-R_1)(R-R_2)(R-R_3)(R-R_4)}{R^2}} (K_1K_2 \cdot K_3K_4+K_1K_4 \cdot K_2K_3) \\
&=\sqrt{\dfrac{(R-R_1)(R-R_2)(R-R_3)(R-R_4)}{R^2}} (K_1K_3 \cdot K_2K_4)=t_{1 3}t_{2 4}, \end{aligned} $$
得证.
...
$\odot O_1$与$\odot O$相切 $\iff$ $A B \cdot t_3+A C \cdot t_2=B C \cdot t_1.$
